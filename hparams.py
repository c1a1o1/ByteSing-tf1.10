...
hparams = tf.contrib.training.HParams(
	...
	duration_zoneout_rate = 0.1,
	duration_layers = 4,
	mask_duration = False, #Whether to use loss mask for padded sequences (if False, <stop_token> loss function will not be weighted, else recommended pos_weight = 20)
	###########################################################################################################################################
